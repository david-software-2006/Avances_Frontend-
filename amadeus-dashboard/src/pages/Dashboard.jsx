...
const Dashboard = () => {
  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        backgroundColor: isLightTheme ? "#f1f1f1" : "#1e1e1e", // Color de fondo en modo oscuro
        display: "flex",
    ...
    >
      ...
      <Box
        sx={{
          backgroundColor: isLightTheme ? "#ffffff" : "#1e1e1e", // Color de fondo en modo oscuro
        ...
        <Container maxWidth="lg">
          <Tooltip title="Cerrar sesión">
            <IconButton
              ...
              sx={{
                backgroundColor: isLightTheme ? "rgba(255, 255, 255, 0.9)" : "rgba(50, 50, 50, 0.9)",
            ...
            <Grid item xs={12} sm={6} md={4} sx={{ display: 'flex' }}>
              ...
              >
                ...
                >
                  ...
                  <Button
                    onClick={() => navigate("/overtime-dashboard")}
                    variant="contained"
                    sx={{
                      marginTop: "1rem",
                      background: isLightTheme
